...
open class Tagging: UIView {
    ...
    public func updateTaggedList(allText: String, tagText: String, tagAttribute: [NSAttributedString.Key: Any], symbolAttribute: [NSAttributedString.Key: Any]) {
  ...
  private func showTaggedList(){
    print("showTaggedList")
    taggedList.forEach{
      print($0.text)
      print($0.range)
      print($0.attribute)
      print($0.symbolAttribute)
    }
